...
create or replace function get_subscores_locf_pvt_sofa(icustay_id bigint, time_window integer)
	returns table (
...
begin
	return query 
		select 	scores_sheet.tw_hour_idx, 
				scores_sheet.cardiovascular_points, 
				scores_sheet.respiration_points, 
				scores_sheet.creatinine_points, 
				scores_sheet.gcs_points, 
				scores_sheet.bilirubin_points, 
				scores_sheet.platelets_points, 
				scores_sheet.urine_points,
...
-- select * from get_subscores_locf_pvt_sofa(200474,1)